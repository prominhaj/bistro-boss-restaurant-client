...
const Contact = () => {
  return (
    <div>
      ...
      />
      <div className="container mx-auto px-5 py-[60px] md:py-[100px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center items-center gap-6 pt-10">
            {
                locations.map(item => <div className="bg-white border border-gray-200" key={item._id}>
                    ...
                    <div className="px-5 pb-5">
                        <div className="bg-zinc-100 flex flex-col justify-center items-center px-3 h-[180px] object-cover">
                            <h2 className="text-center text-neutral-900 sm:mb-3 text-xl sm:text-2xl font-medium font-['Inter']">{item.name}</h2>
                            <p className="text-center text-neutral-700 mt-2 sm:mt-0 text-sm sm:text-base font-normal font-['Inter']">{item.address} <br /> {item.address2 && item.address}</p>
                        </div>
                    </div>
                </div>)
            }
